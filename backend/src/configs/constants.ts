...
export const DEFAULT_USER_EMAIL = 'admin@gmail.com';
export const DEFAULT_USER_PASSWORD = 'root@password';
export const DEFAULT_USER_AVATAR = "https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png";
